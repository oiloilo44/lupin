...
class GameConstants:
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        if isinstance(metadata, dict):
            return {
                "display_name": str(metadata.get("display_name", self._game_name.title())),
                "description": str(metadata.get("description", f"{self._game_name} 게임")),
...
class ServerConstants:
    ...
    def room_config(self) -> Dict[str, Any]:
        ...
        return {"max_rooms": 500, "default_cleanup_delay": 1800, "inactive_threshold": 3600}
