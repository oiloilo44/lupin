...
from .models import ChatMessage, MessageType, OmokGameState, WebSocketMessage
...
class WebSocketHandler:
    ...
    async def _handle_reconnect(
        ...
        if room.room_id != room_id:
            error_msg = f"다른 게임 방({room.room_id})에 참여 중입니다."
    ...
    async def _handle_move(
        ...
        success, winning_line, error_msg = self.omok_manager.make_move(
            room, player, x, y
        )
