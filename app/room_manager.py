...
class RoomManager:
    ...
    def create_omok_room(self) -> tuple[str, str]:
        ...
        return room_id, self.omok_manager.get_url_path(room_id)
    ...
    def create_janggi_room(self) -> tuple[str, str]:
        ...
        self.rooms[room_id] = room
        return room_id, self.janggi_manager.get_url_path(room_id)
    ...
    def update_player_connection_status_old(
        self, room_id: str, session_id: str, is_connected: bool
    ):
